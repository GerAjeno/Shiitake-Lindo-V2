...
import { AsignacionSensoresPanel } from "@/components/settings/AsignacionSensoresPanel";
...
const VISUAL_ATRILES: VisualZona = {
  ...
  subtitulo: "Sensores asignados: ver \"Asignación de sensores por zona\" más abajo",
